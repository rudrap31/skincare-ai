...
import { Modal, View, Text, TouchableOpacity, Linking, Pressable } from 'react-native';
        ...
        >
          ...
          >
            ...
            <View className="flex-row justify-between space-x-4 gap-4">
              <TouchableOpacity
                onPress={() => openLink('https://simplyskin.vercel.app/privacy')}
              ...
              <TouchableOpacity
                onPress={() => openLink('https://simplyskin.vercel.app/terms')}
